...
public class SmsSendMsgHandle implements ISendMsgHandle {
	/*private final static String username = "654713";
	private final static String password = "lk@0921";
	private final static String url = "http://222.73.31.143:7891/mt";*/
	@Override
	public void SendMsg(String es_receiver, String es_title, String es_content , SysMessage sysMessage) {
		// TODO Auto-generated method stub
		System.out.println("发短信");
		try {
			DySmsHelper.sendSms(2,"短信通知",es_receiver,null, sysMessage.getEsContent(),sysMessage.getThirdPartyIdentification(),sysMessage.getEsParam());
		}catch (Exception e){
			e.printStackTrace();
		}
