...
public class FindsDepartsChildrenUtil {
     ...
     */
    public static List<SysDepartTreeModel> findChildren(List<SysDepartTreeModel> recordList,
     ...
     */
    public static void setEmptyChildrenAsNull(List<SysDepartTreeModel> treeList) {
