...
public class SysDepart implements Serializable {
	...
	*//**地址*//*
	...
	/**备注*/
	@Excel(name="备注",width=150)
	private String memo;

	/**短信提醒*/
	/*@Excel(name="短信提醒",width=1)
	@Dict(dicCode = "sms_alerts")
	private Integer smsAlerts;*/
	...
	public int hashCode() {
		...
		return Objects.hash(super.hashCode(), id, parentId, departName, departOrder, orgType, memo,
